...
import checkPendingBooking from "../controllers/tourController.js"
...
router.patch("/status/:id", TourController.updateTourStatus);
...
// route
router.get("/booking/check-pending", checkPendingBooking);
router.patch("/booking/:id/cancel", TourController.cancelPendingBooking);
//Hiển thị thông tin tour đã đặt
router.get("/bookingDetail/:id", TourController.viewBookedTour);
//Hiển thị danh sách các tour để làm quản lí đặt tour
router.get("/booking/viewBooking", TourController.getViewTour);
